"""
Django settings for SharingThings project.
...
SECRET_KEY = 'qof$%#=z1#7!f*zh+!!s9&nv7v=&1h^p4_&p_wpgnme$qy1ztd'
...
ROOT_URLCONF = 'SharingThings.urls'
...
WSGI_APPLICATION = 'SharingThings.wsgi.application'
